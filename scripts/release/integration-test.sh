...
PORT="${PORT:-18443}"
# Match the packaged server's IPv4 loopback default explicitly. On hosts
# where localhost resolves to ::1 first, probing localhost can fail before
# falling back to the IPv4 listener.
